            ...
            <div className="absolute inset-0 bg-gradient-to-br from-retro-pink to-retro-orange rounded-lg transform rotate-3 shadow-lg">
              <div className="absolute inset-[2px] bg-white/90 backdrop-blur-sm rounded-lg">
                <div className="absolute inset-2 bg-gradient-to-br from-retro-pink/80 to-retro-orange/80 rounded-lg">
                  ...
                  <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-white/80 rounded-sm transform rotate-12 shadow-inner"></div>
                  <div className="absolute bottom-1/4 right-1/4 w-3 h-3 bg-white/80 rounded-sm transform -rotate-12 shadow-inner"></div>
                </div>
              </div>
            </div>
            {/* Straw with enhanced styling */}
            <div className="absolute top-0 right-1/3 w-2 h-3/4 bg-retro-yellow shadow-md transform rotate-12 rounded-full"></div>
          </div>
        </motion.div>
